...
from stone.ir import DataType, List, String, Struct, Timestamp, Union, Void
from stone.ir.data_types import _BoundedFloat, _BoundedInteger
            ...
            with self.indent():
                ...
                for field in data_type.fields:
                    ...
                    if not field.has_default:
                        self.emit(f"{field.name} {type_repr}")
                    else:
                        self.emit(
                            "%s %s = %s"
