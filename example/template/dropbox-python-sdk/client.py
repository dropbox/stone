    ...
    def __init__(self,
        ...
        Parameters
            ...
            thumb_exists (bool)
                ...
                via the :meth:`dropbox.client.Dropbox.thumbnails` call.
            icon (str)
            ...
            hash (str)
                ...
                contents in later calls to
                :meth:`dropbox.client.Dropbox.metadata`. This is roughly the
    ...
    def __init__(self,
        ...
        Parameters
            reset (bool)
                ...
                entries. reset is always true on the initial call to
                :meth:`dropbox.client.Dropbox.delta` (i.e. when no cursor is
                passed in). Otherwise, it is true in rare situations, such as
                after server or account maintenance, or if a user deletes their
                app folder.
            cursor (str)
                A string that encodes the latest information that has been
                returned. On the next call to
                :meth:`dropbox.client.Dropbox.delta`, pass in this value.
            has_more (bool)
                If true, then there are more entries available; you can call
                :meth:`dropbox.client.Dropbox.delta` again immediately to retrieve
                those entries. If 'false', then wait for at least five minutes
...
class DropboxClient(object):
    ...
    def put_file(self, f, path, locale=None, overwrite=None, parent_rev=None):
        ...
        Parameters
            ...
            parent_rev (str)
                ...
                :meth:`dropbox.client.Dropbox.metadata`.
    ...
    def metadata(self, path, locale=None, file_limit=10000, hash=None, list=True, include_deleted=True, rev=None, include_media_info=None):
        ...
        Parameters
            ...
            hash (str)
                Each call to :meth:`dropbox.client.Dropbox.metadata` on a folder
                will return a hash field, generated by hashing all of the metadata
                contained in that response. On later calls to :op`Metadata`, you
                should provide that value via this parameter so that if nothing
                has changed, the response will be a 304 (Not Modified) status code
                instead of the full, potentially very large, folder listing. This
                parameter is ignored if the specified path is associated with a
                file or if list=false. A folder shared between two users will have
