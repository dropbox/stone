...
class TestGeneratedJSClient(unittest.TestCase):
    ...
    def test_request_options_flag(self):
        # type: () -> None
        api, _ = self._get_api()
        backend = JavascriptClientBackend(
            target_folder_path='output',
        ...
        expected = textwrap.dedent('''\
             ...
             * @returns {Promise.<void, Error.<void>>}
             */
            routes.filesGetMetadata = function (options) {
              return this.request("files/get_metadata", null, options);
            };
             ...
             * @returns {Promise.<number, Error.<void>>}
             */
            routes.filesGetMetadataV2 = function (options) {
              return this.request("files/get_metadata_v2", null, options);
            };
             ...
             * @returns {Promise.<number, Error.<void>>}
             */
            routes.filesGetMetadataV3 = function (arg, options) {
              return this.request("files/get_metadata_v3", arg, options);
            };
