...
from stone.ir import Api, ApiNamespace, ApiRoute, Int32, Void
...
class TestGeneratedTSDClient(unittest.TestCase):
    ...
    def _get_api(self):
        ...
        route2.set_attributes(
            None, ":route:`get_metadata:2`", Void(), Int32(), Void(), {}
        )
    ...
    def test__generate_types_single_ns(self) -> None:
        api, _ = self._get_api()
        backend = TSDClientBackend(target_folder_path="output", args=["files", "files"])
    ...
    def test_route_with_version_number_conflict(self) -> None:
