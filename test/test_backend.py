...
"""
        ...
        t.generate_multiline_list(
            ["a=1", "b=2"], before="function_to_call", compact=False
        )
        expected = """\
function_to_call(
    a=1,
...
"""
        ...
        t.generate_multiline_list(
            ["a=1", "b=2"], "function_to_call", compact=False, skip_last_sep=True
        )
        expected = """\
function_to_call(
    a=1,
...
"""
        ...
        t.generate_multiline_list(
            ["a=1", "b=2"], "def func", ":", compact=False, skip_last_sep=True
        )
        expected = """\
def func(
    a=1,
...
"""
    ...
    def test_strip_alias(self):
        ...
        test_struct.set_attributes(
            None, [StructField("field1", List(Nullable(first_alias)), None, None)]
        )
    ...
    def test_preserve_aliases_from_api(self):
        ...
        dependent_struct.set_attributes(
            None,
            [
                StructField(
                    "field_alias", imported.alias_by_name["BarAlias"], None, None
                )
            ],
        )
        ...
        data_types = {data_type._name: data_type for data_type in ns.data_types}
