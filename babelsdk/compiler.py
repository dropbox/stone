...
class Compiler(object):
    ...
    def _process_file(self, source_path, target_path):
        ...
        if matches:
        ...
        elif os.path.splitext(source_path)[1] != '.py':
            # A non-Python file must have a preamble.
            raise MissingBabelPreamble()
        else:
            self._logger.info('Running generator %s', target_path)
            ...
            target_folder_path = os.path.split(target_path)[0]
            ...
            for attr_key in dir(generator_module):
                ...
                if (inspect.isclass(attr_value)
                    ...
                    generator = attr_value(self.api, target_folder_path)
                    generator.generate()
