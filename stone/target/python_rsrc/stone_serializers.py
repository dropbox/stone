...
class StoneToPythonPrimitiveSerializer(StoneSerializerBase):
    ...
    def __init__(self, caller_permissions, alias_validators, for_msgpack, old_style, should_redact):
        ...
        Args:
            ...
            old_style (bool, optional): See the like-named property.
                Defaults to ``False``.
            should_redact (bool, optional): Whether to perform redaction on marked fields
                Defaults to ``False``.
        """
    ...
    def encode_list(self, validator, value):
        ...
        return [self.encode_sub(validator.item_validator, value_item)
...
class StoneToJsonSerializer(StoneToPythonPrimitiveSerializer):
    ...
    def __init__(self, caller_permissions, alias_validators, for_msgpack, old_style, should_redact):
        super(StoneToJsonSerializer, self).__init__(caller_permissions, alias_validators,
                                                    for_msgpack, old_style, should_redact)
...
def json_encode(data_type, obj, caller_permissions, alias_validators=None, old_style=False,
    ...
    """
    for_msgpack = False
    serializer = StoneToJsonSerializer(caller_permissions, alias_validators, for_msgpack, old_style,
                                       should_redact)
...
def json_compat_obj_encode(data_type, obj, caller_permissions, alias_validators=None,
    ...
    """
    serializer = StoneToPythonPrimitiveSerializer(caller_permissions, alias_validators, for_msgpack,
                                                  old_style, should_redact)
    return serializer.encode(data_type, obj)
...
def json_decode(data_type, serialized_obj, caller_permissions, alias_validators=None, strict=True,
                old_style=False):
    ...
    Args:
        ...
        strict (bool): If strict, then unknown struct fields will raise an
            ...
            from.
        caller_permissions (object): The caller's access permissions.
    ...
    try:
        ...
        return json_compat_obj_decode(
            data_type, deserialized_obj, caller_permissions, alias_validators,
            strict, old_style)

def json_compat_obj_decode(data_type, obj, caller_permissions, alias_validators=None, strict=True,
    ...
    Returns:
        See json_decode().
    """
    decoder = PythonPrimitiveToStoneDecoder(caller_permissions, alias_validators, for_msgpack,
                                            old_style, strict)
