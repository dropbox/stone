...
_cmdline_parser.add_argument(
    "filename",
    help=(
        "The name to give the single TypeScript definition file to contain "
...
_cmdline_parser.add_argument(
    ...
    default="ROUTES",
    help=(
        "The name of the template string to replace with route definitions. "
